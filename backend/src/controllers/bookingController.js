...
async function updateCheckoutHandler(req, res, next) {
  try {
    const result = await bookingService.updateCheckout(req.params.id, req.body);
...
async function updateCheckinHandler(req, res, next) {
  try {
    const result = await bookingService.updateCheckin(req.params.id, req.body);
    res.json({ data: result });
  } catch (error) {
    next(error);
  }
...
async function updateCheckoutHandler(req, res, next) {
  try {
    const result = await updateCheckout(req.params.id, req.body);
    res.json({ data: result });
  } catch (error) {
    next(error);
  }
